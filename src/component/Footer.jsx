const Footer = () => {
  return (
    <footer className="bg-slate-900 pb-12 pt-24" id="contact">
      <div className="container">
        <div className="flex flex-wrap">
          ...
          <div className="mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3">
            ...
            <div className="mt-3 flex items-center">
              <a
                href="https://github.com/yossiadwim"
                target="blank"
                className="mr-3 flex h-9 w-9 items-center justify-center rounded-full border hover:border-teal-500 hover:bg-teal-500 hover:text-white"
              >
                <svg
        ...
        <div className="items-center">
          <hr className="mb-6 mt-6 border-t border-white" />
          <p className="text-center font-semibold text-white">
            Copyright © 2024. Made with{" "}
            <span className="text-cyan-500">ReactJs </span> and{" "}
